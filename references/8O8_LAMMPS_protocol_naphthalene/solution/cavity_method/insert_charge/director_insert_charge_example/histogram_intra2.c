...
int main(int argc, char *argv[]){
  ...
  read=fopen(argv[1], "r");
  write=fopen("G_single2_instant_elec.dat","w");
  write2=fopen("InG_single2_instant_elec.dat","w");
  record=fopen("record_single2_instant_elec.dat","w");
