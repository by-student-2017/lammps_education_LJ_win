...
coord NUC 1 C1' [list 1.500   0.000   0.000]
coord NUC 1 C2' [list 2.052   1.275  -0.565]
coord NUC 1 C3' [list 3.552   1.271  -0.575]
...
topo writegmxtop $resname.top [list ../../../toppar/par_all36_na.prm ]
[atomselect top "all"] writepdb $resname.pdb
exit
'''

fin = open("../../toppar/top_all36_na.rtf")
lines = fin.readlines()
fin.close()
os.chdir("../")
for line in lines:
