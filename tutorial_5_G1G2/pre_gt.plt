...
set table "pre_gt.txt"
#plot 'corr.long.8.dat' u 1:( V_T*( ($2+$3+$4)/6.0+($5+$6+$7)/24.0 ) ) t 'corr.long.8.dat' w lp lw 2 lc rgb "dark-violet"
plot 'corr.long.8.dat' u 1:( V_T*( ($2+$3+$4)/5.0+($5+$6+$7)/30.0 ) ) t 'corr.long.8.dat' w lp lw 2 lc rgb "dark-violet"
unset table