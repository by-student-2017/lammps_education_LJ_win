...
nmolsolvent=864 #solvent molecultes 
...
#"Average_Ucavity" contains the integrands for ΔG_shrink = integration{<dUcavity(lambda)/dlambda>} = integration{<Ucavity(lambda)>} from lambda_min = -10 to lambda_max
#"Error" column is the error in "Average" 
#"mu.dat" contains the free energy perturbation terms for ΔG_shrink
#simply add all the terms in mu.dat to obtain ΔG_shrink
