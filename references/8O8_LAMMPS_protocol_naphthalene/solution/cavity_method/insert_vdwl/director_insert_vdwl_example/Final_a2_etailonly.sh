...
##($6) vdwl tail correction 
awk -v ratio=$kcalmolkt -v nat=$nmol '{print ($6)*ratio}' energies4.dat > kt_energies4.dat
awk -v ratio=$kcalmolkt -v nat=$nmol '{print ($6)*ratio}' energies_intra4.dat > kt_energies_intra4.dat
awk -v ratio=$kcalmolkt -v nat=$nmol '{print ($6)*ratio}' energies3.dat > kt_energies3.dat
awk -v ratio=$kcalmolkt -v nat=$nmol '{print ($6)*ratio}' energies_intra2.dat > kt_energies_intra2.dat

paste -d' ' kt_energies4.dat kt_energies_intra4.dat kt_energies3.dat kt_energies_intra2.dat > kt.dat

awk '{print (($1)-($3))}' kt.dat > u_sol-u_latt.dat
